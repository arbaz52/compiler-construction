...
namespace Lab5
{
    public partial class Form1 : Form
    {
        public Form1()
        {
            ...
            dataGridView1.Columns[1].Name = "Variable Name";
        ...
        private void btn_Input_Click(object sender, EventArgs e)
        {
            ...
            {
                temp += lines[k] + Environment.NewLine;
            }
            userInput = temp;
                    ...
                    else if (variables.Success)
                    {
                        ...
                        if (!keywordList.Contains(finalArrayc[x].ToString())) // if it is not a keyword
                        {
                            ...
                            if (category1.Success)
                            {
                                ...
                                String[] record = {
                                        SymbolTable[row, 1].ToString(),
                                        SymbolTable[row, 2].ToString(),
                                        SymbolTable[row, 3].ToString(),
                                        SymbolTable[row, 4].ToString(),
                                        SymbolTable[row, 5].ToString()
                                    };
        ...
        private void symbolTable_TextChanged(object sender, EventArgs e)
        {
